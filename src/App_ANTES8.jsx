                            ...
                            <div className="space-y-2 relative z-10">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        onFocus={() => { if(!isPatientDataLocked){ setCaserioQuery(""); setShowCaserioList(true); } }}
                                        onChange={(e) => {
                                    ...
                                    {showCaserioList && !isPatientDataLocked && (() => {
                                                ...
                                                {sugerencias.length === 0 ? (
                                                    ...
                                                    <button
                                                        ...
                                                        onMouseDown={(e) => {
                                                            ...
                                                            // Bloqueo automático si la HC ya existe (igual que antes)
                                ...
                                {caserioOriginalHIS && !isPatientDataLocked && !(patientData.direccion && listaCaserios.includes(patientData.direccion)) && (() => {
                                            ...
                                            {sugerido ? (
                                                <button
                                                    ...
                                                    onMouseDown={(e) => {
                                                        ...
                                                        if (patientData.hc && patientData.hc.trim() !== "") setTimeout(() => setIsPatientDataLocked(true), 100);
                                                    }}
