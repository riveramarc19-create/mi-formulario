...
'C2111.01': { 
        1: { label: 'N°', options: ['1','2','3','4','5','6','7'] }, 
            },
'C7001': { 
        1: { label: 'N°', options: ['1','2','3','4','VCO'] }, 
            },
'C0003': { 
        1: [''] , 
            },
		...
		{/* 4. CAMPOS LAB (TEXTO LIBRE, SIN ETIQUETAS, O CON MENÚ) */}
                ...
                <div className="col-span-2 flex gap-1.5 justify-center">
                    {[1, 2, 3].map((n) => {
                        ...
                        // CAMBIO: Los 3 campos LAB están ACTIVOS para TODOS los códigos (texto libre).
                        // Los códigos con configuración conservan sus opciones predeterminadas (LEV, MOD, SEV, TA, etc.)
                        const isSlotActive = currentCode !== "";
                        const slotOptions = Array.isArray(configItem) ? configItem : (configItem?.options || []);
                        
                        // ¿Este campo permite estar vacío?
                        // Los códigos SIN configuración específica permiten vacío (gris, no rojo obligatorio)
                        const canBeEmpty = slotOptions.includes('') || configItem === undefined;
