    ...
    {clinicalData.riesgo || "DIAGNÓSTICO..."} </div>
      ...
      {step === 3 && (
        <div className="animate-in fade-in slide-in-from-right-8 duration-300 w-full max-w-[95%] mx-auto pb-10">
           ...
           <div className="sticky top-0 z-20 bg-white/95 backdrop-blur-sm pt-1 pb-2 -mx-1 px-1 rounded-b-xl">
           ...
           {/* LISTA CON SCROLL INTERNO (aparece cuando hay más de 6 registros) */}
           <div className={`space-y-3 mt-2 pr-1 ${diagnoses.length > 3 ? 'max-h-[52vh] overflow-y-auto' : ''}`}>
