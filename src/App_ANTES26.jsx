                        ...
                        return (
                            <div key={n} className="relative group/lab">
                                ...
                                {isFocused && isSlotActive && slotOptions.length > 0 && (
                                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 border border-white/60 shadow-2xl rounded-2xl p-2 flex gap-1.5 z-50 animate-in zoom-in slide-in-from-bottom-1 duration-200 min-w-[90px] justify-center flex-wrap"
