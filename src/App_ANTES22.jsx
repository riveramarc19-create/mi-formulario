        ...
        <div className={`p-5 rounded-2xl border flex items-start gap-4 backdrop-blur-sm
          ...
          <div className="flex-1">
              ...
              {validationAlert.highlight && (
                  <div className="animate-baile mt-4 inline-block bg-purple-600 text-white text-xs font-black px-4 py-2 rounded-xl shadow-lg uppercase tracking-wide origin-center">
                      ⚠ {validationAlert.highlight}
                  </div>
              )}
          </div>
